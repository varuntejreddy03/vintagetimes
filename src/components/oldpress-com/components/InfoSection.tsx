        ...
        <div className="flex flex-col items-center gap-12 md:gap-16">
          <div className="max-w-2xl md:max-w-3xl lg:max-w-4xl text-center">
            <div className="font-playfair italic text-2xl md:text-3xl lg:text-4xl leading-tight text-[#222020]">
              Vintage Times is building India's first nostalgia-commerce ecosystem. We transform live moments into personalised, vintage newspaper prints — a tactile memory artifact designed for emotional value, display, gifting, and virality.
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative w-32 h-32 md:w-40 md:h-40 flex items-center justify-center rounded-full border border-dashed border-gray-200 p-4">
              <svg
                ...
                viewBox="0 0 132 132"
                fill="none"
                className="w-full h-full object-contain animate-spin opacity-80"
                style={{ animationDuration: '10s' }}
              >
                <use href="/extracted-icons/icon-473aeb0fc160.svg#icon-473aeb0fc160"></use>
              </svg>
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-[10px] font-bold tracking-widest text-[#222020] uppercase bg-[#faf9f6] px-2">Original</span>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-5xl mt-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              ...
              >
                ...
                <span className="text-[10px] font-['Onest'] font-bold tracking-[0.2em] text-[#9d9a95] uppercase mb-2">Call Us</span>
                <span className="text-[#222020] font-playfair italic text-xl group-hover:scale-105 transition-transform duration-500 tracking-tight">+91 70757 46236</span>
              </a>
              ...
              >
                ...
                <span className="text-[10px] font-['Onest'] font-bold tracking-[0.2em] text-[#9d9a95] uppercase mb-2">Connect</span>
                <span className="text-[#222020] font-playfair italic text-xl group-hover:scale-105 transition-transform duration-500 tracking-tight">@vintagetimes.in</span>
              </a>
              ...
              >
                ...
                <span className="text-[10px] font-['Onest'] font-bold tracking-[0.2em] text-[#9d9a95] uppercase mb-2">Write to us</span>
                <span className="text-[#222020] font-playfair italic text-xl group-hover:scale-105 transition-transform duration-500 tracking-tight">contact@vintagetimes.in</span>
              </a>
            </div>
          </div>
        </div>
